...
let BubbleSortComponent = class BubbleSortComponent {
    ...
    generateRandomArray() {
        ...
        for (let i = 0; i < screenWidth / 16; i++) {
            const randomNumber = (Math.random() * (screenHeight - 10) + 10);
...
let CodeAreaComponent = class CodeAreaComponent {
    constructor() {
    }
    ngAfterContentInit() {
        this.initAce();
    ...
    initAce() {
        ...
        const JS = ace_builds_src_noconflict_mode_javascript__WEBPACK_IMPORTED_MODULE_4__["Mode"];
...
let NavbarComponent = class NavbarComponent {
    ...
    ngOnInit() {
        _store_service__WEBPACK_IMPORTED_MODULE_3__["StoreService"].showCodeArea.subscribe((value) => this.showCodeArea = value);
    }
    ToggleShowCodeArea() {
...
let SlowdownService = class SlowdownService {
    constructor() {
        this.speed = 1;
